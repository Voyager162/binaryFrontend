...
<body>
  ...
  <div class="game-container">
    <div class="hearts-container" id="hearts-container">
      <img src="{{site.baseurl}}/images/binaryLearningGame/heart.png" class="heart" id="heart1" alt="Heart1">
      <img src="{{site.baseurl}}/images/binaryLearningGame/heart.png" class="heart" id="heart2" alt="Heart2">
      <img src="{{site.baseurl}}/images/binaryLearningGame/heart.png" class="heart" id="heart3" alt="Heart3">
    </div>
